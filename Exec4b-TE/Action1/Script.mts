...
TeWindow("TeWindow").TeScreen("Si").TeField("Password").SetSecure "6040abc587424d106ea08ac86fc0393f" @@ hightlight id_;_826_;_script infofile_;_ZIP::ssf2.xml_;_
...
TeWindow("TeWindow").InsightObject("InsightObject").Click @@ hightlight id_;_3_;_script infofile_;_ZIP::ssf16.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_2").Click @@ hightlight id_;_13_;_script infofile_;_ZIP::ssf17.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_3").Click @@ hightlight id_;_27_;_script infofile_;_ZIP::ssf18.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_4").Click @@ hightlight id_;_32_;_script infofile_;_ZIP::ssf19.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_5").Click @@ hightlight id_;_38_;_script infofile_;_ZIP::ssf20.xml_;_
